# Generated by Django 5.2.15 on 2026-07-01 23:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['project', 'status'], name='tasks_task_project_b78682_idx'), models.Index(fields=['assignee', 'status'], name='tasks_task_assigne_7928f6_idx')],
            },
        ),
    ]
